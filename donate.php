                    ...
                    <div class="cnt-block">
                        ...
                        <form action="donate.php" method="POST" name="donateform">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <!-- you can get a php code to populate all countries in the world -->
                            </div>
                            <div class="form-group col-lg-6">
                                <label>Email *</label>
                                <input type="email" value="" data-msg-required="Please enter your Email." data-msg-email="Please enter a valid email address." maxlength="100" class="form-control" name="email" id="email" required>
                            </div>
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input type="text" value="" data-msg-required="Please enter your Phone Number." data-msg-email="Please enter your Phone Number." maxlength="100" class="form-control" name="phone" id="phone" required>
                            </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    &nbsp;&nbsp;
                                    <input type="radio" name="paymentmode" value="UGXPRESSPAY" id="visaCheck" onclick="javascript:paymentCheck();">
                                    <img alt="" width="70" src="logos/visa.jpg">
                                    ...
                                    <img alt="" width="70" src="logos/interswitch.jpg">
                                    ...
                                    <img alt="" width="80" src="logos/africell.png">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-lg-6">
                                    <input type="submit" name="donate" value="Process Payment" class="btn btn-primary btn-lg" data-loading-text="Loading...">
                                    <input type="reset" name="reset" value="Reset" class="btn btn-secondary btn-lg" data-loading-text="Loading...">
                                </div>
